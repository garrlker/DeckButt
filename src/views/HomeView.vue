  ...
  <div class="container mx-auto max-w-min min-h-min">
    <div
      ...
      <div class="w-full md:w-1/6 px-3">
        <label for="models" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
          Model
        </label>
        <select id="models"
      ...
      <div class="w-full md:w-1/6 px-3">
        <label for="regions" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
          Region
        </label>
        <select id="regions"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div class="w-full md:w-1/2 px-3">
        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="reserve-time">
          Reserve Time
        </label>
        <input v-model="reserveTime"
          class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
          id="reserve-time" type="number" placeholder="Reserve Time" />
      </div>
